...
functionally idential, classes. We also need to reconstruct instances of those classes defined inside the bundle when
...
For this, in the Domain Expansion integration code, we add an empty opject to the global scope under a private symbol
