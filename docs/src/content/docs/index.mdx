...
1. Astro Docs, time to build (domain expansion vs default)
2. Starlight docs, time to build (domain expansion vs default)
3. astro.build, time to build (domain expansion vs default)
4. Astrowind basic install, time to build (domain expansion vs default)
5. Cloudflare docs, time to build (domain expansion vs default)
6. StudioCMS/UI Docs, time to build (domain expansion vs default)
...
Pray that [Rolldown](https://rolldown.rs/) gets released soon. It accounts for about 90% of the build time
